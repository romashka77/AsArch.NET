...
ReactDOM.render(
    <SudZas
        controller="Nodes"
        actionGetSudZas="GetSudZas"
        actionGetListDict="GetListDictJson"
        actionGetListTabConfig="GetListTabConfig"
        actionPostSudZas="PostSudZas"
        actionDeleteSudZas="DeleteSudZas"
